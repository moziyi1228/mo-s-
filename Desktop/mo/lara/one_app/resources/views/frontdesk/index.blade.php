...
<body>
  ...
  <header>
    <div class="nav-bar">
      <img src="{{URL::asset('assets1/svg/bar.svg')}}" class="img-fluid" alt="">
    </div>
    <a href="index.blade.php" class="brand-logo">
      <img src="{{URL::asset('img/one_heart_club.jpg')}}" class="img-fluid" alt="">
    </a>
...
{{--    </div>--}}
  ...
  <div class="header-sidebar">
    <a href="/front/profilesetting" class="user-panel">
      <img src="{{URL::asset('assets1/images/user/1.png')}}" class="img-fluid user-img" alt="">
      <span>Hello, {{$username?$username:'游客'}}</span>
...
{{--        <li>--}}
{{--          <a href="#">--}}
{{--            <img src="{{URL::asset('assets1/images/flag.png')}}" class="img-fluid" alt="">--}}
{{--            <div class="content">--}}
{{--              <h4>Langauge</h4>--}}
...
{{--          <img src="{{URL::asset('assets1/images/top-category/kids.png')}}" class="img-fluid" alt="">--}}
{{--          <h4>Kids</h4>--}}
{{--        </a>--}}
{{--      </li>--}}
{{--      <li>--}}
{{--        <a href="inner-category.html" class="category-box">--}}
{{--          <img src="{{URL::asset('assets1/images/top-category/beauty.png')}}" class="img-fluid" alt="">--}}
{{--          <h4>beauty</h4>--}}
{{--        </a>--}}
{{--      </li>--}}
{{--      <li>--}}
{{--        <a href="inner-category.html" class="category-box">--}}
{{--          <img src="{{URL::asset('assets1/images/top-category/shoes.png')}}" class="img-fluid" alt="">--}}
{{--          <h4>footwear</h4>--}}
{{--        </a>--}}
{{--      </li>--}}
{{--      <li>--}}
{{--        <a href="inner-category.html" class="category-box">--}}
{{--          <img src="{{URL::asset('assets1/images/top-category/jewelry.png')}}" class="img-fluid" alt="">--}}
{{--          <h4>jewelry</h4>--}}
{{--        </a>--}}
{{--      </li>--}}
{{--      <li>--}}
{{--        <a href="inner-category.html" class="category-box">--}}
{{--          <img src="{{URL::asset('assets1/images/top-category/women.png')}}" class="img-fluid" alt="">--}}
{{--          <h4>Women</h4>--}}
{{--        </a>--}}
{{--      </li>--}}
{{--      <li>--}}
{{--        <a href="inner-category.html" class="category-box">--}}
{{--          <img src="{{URL::asset('assets1/images/top-category/men.png')}}" class="img-fluid" alt="">--}}
{{--          <h4>men</h4>--}}
{{--        </a>--}}
{{--      </li>--}}
{{--    </ul>--}}
    ...
    <div class="home-slider slick-default theme-dots">
      <div>
        <div class="slider-box">
          <img src="{{URL::asset('assets1/images/home-slider/1.jpg')}}" class="img-fluid bg-img" alt="">
      ...
      <div>
        <div class="slider-box">
          <img src="{{URL::asset('assets1/images/home-slider/2.jpg')}}" class="img-fluid bg-img" alt="">
          <div class="slider-content">
            <div>
              <h2>Welcome To Multikart</h2>
              <h1>Flat 50% OFF</h1>
      ...
      <div class="row gy-3">
        <div class="col-12">
          <div class="product-inline">
            <a href="product.html">
              <img src="{{URL::asset('assets1/images/products/2.jpg')}}" class="img-fluid" alt="">
            </a>
...
{{--                <div class="img-part">--}}
{{--                  <a href="product.html"><img src="{{URL::asset('assets1/images/products/4.jpg')}}" alt="" class="img-fluid bg-img"></a>--}}
{{--                  <div class="wishlist-btn">--}}
{{--                    <i class="iconly-Heart icli"></i>--}}
{{--                    <i class="iconly-Heart icbo"></i>--}}
{{--                    <div class="effect-group">--}}
...
{{--              <div class="product-box ratio_square">--}}
{{--                <div class="img-part">--}}
{{--                  <a href="product.html"><img src="{{URL::asset('assets1/images/products/5.jpg')}}" alt="" class="img-fluid bg-img"></a>--}}
{{--                  <div class="wishlist-btn">--}}
{{--                    <i class="iconly-Heart icli"></i>--}}
{{--                    <i class="iconly-Heart icbo"></i>--}}
{{--                    <div class="effect-group">--}}
...
{{--              <div class="product-box ratio_square">--}}
{{--                <div class="img-part">--}}
{{--                  <a href="product.html"><img src="{{URL::asset('assets1/images/products/6.jpg')}}" alt="" class="img-fluid bg-img"></a>--}}
{{--                  <div class="wishlist-btn">--}}
{{--                    <i class="iconly-Heart icli"></i>--}}
{{--                    <i class="iconly-Heart icbo"></i>--}}
{{--                    <div class="effect-group">--}}
...
{{--              <div class="product-box ratio_square">--}}
{{--                <div class="img-part">--}}
{{--                  <a href="product.html"><img src="{{URL::asset('assets1/images/products/7.jpg')}}" alt="" class="img-fluid bg-img"></a>--}}
{{--                  <div class="wishlist-btn">--}}
{{--                    <i class="iconly-Heart icli"></i>--}}
{{--                    <i class="iconly-Heart icbo"></i>--}}
{{--                    <div class="effect-group">--}}
...
{{--        <img src="{{URL::asset('assets1/images/banner-image.png')}}" class="img-fluid" alt="">--}}
{{--      </div>--}}
{{--    </div>--}}
{{--  </section>--}}
  <!-- timer banner end -->
...
{{--          <img src="{{URL::asset('assets1/images/brand-logos/1.png')}}" class="img-fluid" alt="">--}}
{{--        </a>--}}
{{--      </div>--}}
{{--      <div>--}}
{{--        <a class="brand-box" href="shop.html">--}}
{{--          <img src="{{URL::asset('assets1/images/brand-logos/2.png')}}" class="img-fluid" alt="">--}}
{{--        </a>--}}
{{--      </div>--}}
{{--      <div>--}}
{{--        <a class="brand-box" href="shop.html">--}}
{{--          <img src="{{URL::asset('assets1/images/brand-logos/3.png')}}" class="img-fluid" alt="">--}}
{{--        </a>--}}
{{--      </div>--}}
{{--      <div>--}}
{{--        <a class="brand-box" href="shop.html">--}}
{{--          <img src="{{URL::asset('assets1/images/brand-logos/4.png')}}" class="img-fluid" alt="">--}}
{{--        </a>--}}
{{--      </div>--}}
{{--      <div>--}}
{{--        <a class="brand-box" href="shop.html">--}}
{{--          <img src="{{URL::asset('assets1/images/brand-logos/5.png')}}" class="img-fluid" alt="">--}}
{{--        </a>--}}
{{--      </div>--}}
{{--    </div>--}}
{{--  </section>--}}
...
{{--        <div class="product-box ratio_square">--}}
{{--          <div class="img-part">--}}
{{--            <a href="product.html"><img src="{{URL::asset('assets1/images/products/9.jpg')}}" alt="" class="img-fluid bg-img"></a>--}}
{{--            <div class="wishlist-btn">--}}
{{--              <i class="iconly-Heart icli"></i>--}}
{{--              <i class="iconly-Heart icbo"></i>--}}
{{--              <div class="effect-group">--}}
...
{{--        <div class="product-box ratio_square">--}}
{{--          <div class="img-part">--}}
{{--            <a href="product.html"><img src="{{URL::asset('assets1/images/products/10.jpg')}}" alt="" class="img-fluid bg-img"></a>--}}
{{--            <div class="wishlist-btn">--}}
{{--              <i class="iconly-Heart icli"></i>--}}
{{--              <i class="iconly-Heart icbo"></i>--}}
{{--              <div class="effect-group">--}}
...
{{--        <div class="product-box ratio_square">--}}
{{--          <div class="img-part">--}}
{{--            <a href="product.html"><img src="{{URL::asset('assets1/images/products/8.jpg')}}" alt="" class="img-fluid bg-img"></a>--}}
{{--            <div class="wishlist-btn">--}}
{{--              <i class="iconly-Heart icli"></i>--}}
{{--              <i class="iconly-Heart icbo"></i>--}}
{{--              <div class="effect-group">--}}
...
{{--    <h2 class="title">Offer Corner</h2>--}}
{{--    <div class="row g-3">--}}
{{--      <div class="col-6">--}}
{{--        <div class="offer-box">--}}
{{--          <a href="shop.html">Under $50.00</a>--}}
{{--        </div>--}}
{{--      </div>--}}
{{--      <div class="col-6">--}}
{{--        <div class="offer-box">--}}
{{--          <a href="shop.html">Flat $20 OFF</a>--}}
{{--        </div>--}}
{{--      </div>--}}
{{--      <div class="col-6">--}}
{{--        <div class="offer-box">--}}
{{--          <a href="shop.html">buy 1 get 1</a>--}}
{{--        </div>--}}
{{--      </div>--}}
{{--      <div class="col-6">--}}
{{--        <div class="offer-box">--}}
{{--          <a href="shop.html">upto 50% off</a>--}}
{{--        </div>--}}
{{--      </div>--}}
{{--    </div>--}}
{{--  </section>--}}
...
{{--      <div class="app-info">--}}
{{--        <img src="{{URL::asset('assets1/images/logo/logo48.png')}}" class="img-fluid" alt="">--}}
{{--        <div class="content">--}}
{{--          <h3>Multikart App</h3>--}}
...
{{--  </div>--}}
  ...
  <!-- Slick js-->
  <script src="{{URL::asset('assets1/js/homescreen-popup.js')}}"></script>

  <!-- timer js-->
  <script src="{{URL::asset('assets1/js/timer.js')}}"></script>

  <!-- offcanvas modal js -->
  <script src="{{URL::asset('assets1/js/offcanvas-popup.js')}}"></script>
