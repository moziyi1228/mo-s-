    ...
    <script >
        ...
        $(document).ready(function(){
            ...
            $("#form").submit(function(){
                ...
                if(!username){
                    $('#exampleInputName').attr("placeholder","用户名不能为空");
                }else if(!password){
                    $('#exampleInputPassword').attr("placeholder","密码不能为空");
                }else {
                    //请求验证账号密码
                    ...
                    $.ajax({
                        ...
                        success: function (data,status) {
                           if(data==false){
                               ...
                               window.location.replace("/index/"+data['userid']);
                           }
                        },
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" id="form" method="post" action=" ">
                                        @csrf
                                        <div class="form-group">
                                            <input type="email1" class="form-control form-control-user"
