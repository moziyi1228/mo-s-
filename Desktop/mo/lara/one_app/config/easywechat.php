...
return [
     ...
     */
     'mini_app' => [
         'default' => [
             'app_id'     => env('WECHAT_MINI_APP_APPID', 'wxec569e12169d47b8'),
             'secret'     => env('WECHAT_MINI_APP_SECRET', '317512dce4181d360e6d0074142189f4'),
...
//                 */
     ...
     */
     'pay' => [
         'default' => [
             'app_id'             => env('WECHAT_PAY_APPID', 'wxec569e12169d47b8'),
             'mch_id'             => env('WECHAT_PAY_MCH_ID', '1630134826'),
             'private_key'        => __DIR__.'../public/1630134826_20220816_cert/apiclient_key.pem',
             'certificate'        => __DIR__.'../public/1630134826_20220816_cert/apiclient_cert.pem',
             'notify_url'         => 'https://www.one4616.club/payments/wechat-notify',                           // 默认支付结果通知地址
//              /**
//               * 证书序列号，可通过命令从证书获取：
...
//               */
              ...
              // v3 API 秘钥
              'secret_key' => '3317512dce4181d360e6d00741421one',
         ],
     ],
